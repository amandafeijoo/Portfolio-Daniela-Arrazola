...
from .views import crear_testimonio, listar_testimonios, aprobar_testimonio, eliminar_testimonio,enviar_correo_testimonio
...
urlpatterns = [
    ...
    path("testimonios/enviar-correo/", enviar_correo_testimonio, name="enviar-correo-testimonio"),  # ✅ Nueva ruta para enviar correo manual
