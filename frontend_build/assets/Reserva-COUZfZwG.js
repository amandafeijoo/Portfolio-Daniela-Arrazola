import{y as W,J as q,r as t,h as _,j as e,z as M,t as z,w as H,u as U,d as m,m as Y,B as J,W as k,T as R}from"./index-lO-UZ-_8.js";import{C as V}from"./Calendar-BDfmW3OA.js";import{W as L}from"./WhatsAppContact-CA-nViRN.js";import{i as E}from"./imagePath-CxLw2Y1l.js";import{G as w,I as $}from"./InfoBoxesReserva-PcmUQ8wK.js";import{S as f}from"./sweetalert2.esm.all-BY1s0Tb6.js";import{T as h,F as Q}from"./TextField-DABP1SCw.js";import{u as K,f as X}from"./Select-D_REWnQI.js";import{F as Z,C as ee}from"./FormControlLabel-zM0a-ueU.js";import{B as oe}from"./Button-B9Q7xakn.js";import"./index-DYHD4lVr.js";import"./getThemeProps-C695Ic0w.js";import"./index-mdCQDDk3.js";import"./useControlled-DIRPo7Gv.js";import"./InputAdornment-siGFVtz0.js";function re(r){return W("MuiFormGroup",r)}q("MuiFormGroup",["root","row","error"]);const te=r=>{const{classes:a,row:i,error:l}=r;return H({root:["root",i&&"row",l&&"error"]},re,a)},ae=M("div",{name:"MuiFormGroup",slot:"Root",overridesResolver:(r,a)=>{const{ownerState:i}=r;return[a.root,i.row&&a.row]}})({display:"flex",flexDirection:"column",flexWrap:"wrap",variants:[{props:{row:!0},style:{flexDirection:"row"}}]}),ie=t.forwardRef(function(a,i){const l=_({props:a,name:"MuiFormGroup"}),{className:c,row:b=!1,...d}=l,v=K(),u=X({props:l,muiFormControl:v,states:["error"]}),g={...l,row:b,error:u.error},x=te(g);return e.jsx(ae,{className:z(x.root,c),ownerState:g,ref:i,...d})}),se=Y`
...
`,de=()=>{const r=U(),a=()=>{r("/faq")};return e.jsxs(ne,{children:[e.jsxs(le,{children:[e.jsx(D,{children:e.jsx(L,{})}),e.jsx(D,{onClick:a,children:e.jsx("img",{src:E("faq.svg"),alt:"FAQ"})})]}),e.jsxs(ce,{autoPlay:!0,loop:!0,muted:!0,playsInline:!0,controlsList:"nofullscreen",children:[e.jsx("source",{src:E("reserva.mp4"),type:"video/mp4"}),"Tu navegador no soporta el video."]})]})},pe=m.div`
