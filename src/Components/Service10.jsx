...
const Image = () => (
  <Box sx={{ width: '72%', marginBottom: 2, boxShadow: '0 0 5px 2px rgba(0, 0, 0, 0.7), 0 0 10px 4px rgba(34, 139, 34, 0.2), 0 0 15px 6px rgba(0, 0, 0, 0.2)', borderRadius: 2, overflow: 'hidden', border: '2px solid #d2b48c' }}>
    <img src="/images/10.svg" alt="Service Image" width="100%" style={{ borderRadius: 'inherit' }} />
  </Box>
);
            ...
            <Accordion sx={{ margin: 2, backgroundColor: '#f5eedc', border: '2px solid #d2b48c', borderRadius: 2, boxShadow: '0 0 5px 2px rgba(0, 0, 0, 0.3), 0 0 10px 4px rgba(34, 139, 34, 0.2), 0 0 15px 6px rgba(0, 0, 0, 0.2)' }}>
              <AccordionSummary expandIcon={<ExpandMoreIcon />} sx={{ backgroundColor: 'rgba(48, 84, 69, 0.8)', color: '#f5eedc' }}>
                <Typography variant="h5" component="h2" sx={{ fontFamily: 'Playfair Display' }}>
                  El miedo es una emoción natural y necesaria para nuestra supervivencia.
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography variant="body1" sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display', textAlign: 'justify', lineHeight: 1.6 }}>
                  El miedo es una emoción natural y necesaria para nuestra supervivencia, pero cuando se vuelve intenso, irracional y limitante, deja de protegernos y empieza a controlarnos. Tal vez evitas situaciones, lugares o incluso actividades que antes disfrutabas, lo cual no solo te limita, sino que también te lleva a experimentar niveles intensos de ansiedad.
                </Typography>
                <Typography variant="body1" sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display', textAlign: 'justify', lineHeight: 1.6, marginTop: 2 }}>
                  En terapia trabajamos con enfoques basados en la evidencia científica:
                </Typography>
                <List>
                  <ListItem sx={{ backgroundColor: '#fff', margin: 1, borderRadius: 1, boxShadow: 1 }}>
                    <ListItemText primary="Aprenderás a regular tu respuesta de miedo." sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display' }} />
                  </ListItem>
                  <ListItem sx={{ backgroundColor: '#fff', margin: 1, borderRadius: 1, boxShadow: 1 }}>
                    <ListItemText primary="Enfrentarás progresivamente aquello que hoy evitas." sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display' }} />
                  </ListItem>
                  <ListItem sx={{ backgroundColor: '#fff', margin: 1, borderRadius: 1, boxShadow: 1 }}>
                    <ListItemText primary="Retomarás el control de tus emociones y decisiones." sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display' }} />
                  </ListItem>
                </List>
                <Typography variant="body1" sx={{ color: '#4b3f2f', fontFamily: 'Playfair Display', textAlign: 'justify', lineHeight: 1.6 }}>
                  Las fobias pueden hacerte sentir atrapado, pero con el acompañamiento adecuado puedes aprender a enfrentarlas y superarlas. No será de un día para otro, ni de eliminar el miedo por completo, sino de hacer que deje de gobernar en tus decisiones.
                </Typography>
              </AccordionDetails>
            </Accordion>
          </Box>
